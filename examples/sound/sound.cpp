...
namespace
{
    void playSound()
    {
        ...
        const clyde::SoundBuffer buffer("assets/killdeer.wav");
        ...
        clyde::Sound sound(buffer);
        sound.play();

        // Loop while the sound is playing
        while (sound.getStatus() == clyde::Sound::Status::Playing)
        {
    ...
    void playMusic(const std::filesystem::path &filename)
    {
        ...
        clyde::Music music("assets" / filename);
        ...
        while (music.getStatus() == clyde::Music::Status::Playing)
        {
            // Display the playing position
